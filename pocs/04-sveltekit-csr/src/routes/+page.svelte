...
<main style="padding: 2rem; max-width: 600px; margin: 0 auto;">
	<h1>POC 4: SvelteKit CSR Only</h1>
	<p><strong>Test:</strong> wa-select with reactive disabled property (CSR Only - SSR Disabled)</p>
	...
	<div style="margin-top: 3rem; padding: 1rem; background: #fff3cd; border-radius: 4px;">
		...
		<ol>
			<li>This is SvelteKit with SSR <strong>disabled</strong> (CSR only)</li>
		...
		<p><strong>Note:</strong> SSR is disabled via +page.ts. Compare with POC 1 (SSR enabled) and POC 3 (plain Svelte).</p>
